...
class _DirectBlocksListener(BaseBlocksListener):
    ...
    def _waly_event_received(self, data: dict, topics: list[str]) -> None:
        Thread(
            target=self._on_event_received,
            args=(data, topics),
    ...
    def get_block(self, block_id: bytearray) -> Block:
        return WalytisBetaDirectInterface.get_block(
            self.blockchain_id, block_id
        )
...
class WalytisBetaDirectInterface(BaseWalytisBetaInterface):
    ...
    def get_latest_blocks(
        ...
        if long_ids:
            ...
            return [short_from_long_id(block_id) for block_id in block_ids]
    ...
    def create_invitation(
        ...
        """
        blockchain = cls._get_blockchain(blockchain_id)
        return blockchain.create_invitation(one_time=one_time, shared=shared)
